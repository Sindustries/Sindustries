class SMS_blood
{
	...
	fadein=1;
	duration = 1e+1000;
	onLoad = "uiNameSpace setVariable ['SMSHUDBloodcount', (_this select 0) displayCtrl 204];";
	
	class controls
	{		
		class SMSHUDBloodBG: IGUIBack
		{
			idc = 2201;
		...
		class SMSHUD_bloodimg: RscPicture
		{
			idc = 208;
		...
		class SMSHUDBloodcount: RscText
		{
			idc = 204;
