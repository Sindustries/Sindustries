	...
	while {alive _unit} do {
		...
		waitUntil {(_unit getVariable "SMS_bleedingRate") isEqualTo 0 && (_unit getVariable "SMS_bloodLevel") < SMS_maxBlood};
		...
		uiNameSpace getVariable "SMSHUDBloodcount" ctrlSetText format["%1%2",_bloodDisplay,"%"];
		uiNameSpace getVariable "SMSHUDBloodcount" ctrlSetTextColor [0, 1, 0, 1];
